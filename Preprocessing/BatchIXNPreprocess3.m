% BatchIXNPreprocess3(red_cali_img, BlankRedBackgroundImg,
% green_cali_img, BlankGreenBackgroundImg, ErrorMessageRecipient,
% data_folder, experiment_date, varargin)
function BatchIXNPreprocess3(red_cali_img, BlankRedBackgroundImg, ...
    green_cali_img, BlankGreenBackgroundImg, ErrorMessageRecipient, ...
    data_folder, experiment_date, varargin)
    ...
    % variables can be saved if BatchIXNPreprocess3 is called
    ...
    for i = 1 : size(PositionList, 1)
        try
            ...
            IXNPreprocess3(red_path, red_cali_img, BlankRedBackgroundImg, ...
            ...
            if strcmp(PreprocessError.identifier, 'MATLAB:imagesci:readtif:indexInfoMismatch')
                delete(sprintf('%s%s%s%s_composite.tif', data_folder, filesep, experiment_date, position_suffix));
                cprintf('Errors', ...
